<template>
  <div class="modal" id="newDocumentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="col">
                  ...
                  <div class="row">
                    <div class="col d-flex">
                      <input type="file" id="attachFile" multiple @change="fileChanged" v-show="false">
...
export default {
  ...
  methods: {
    ...
    createDocument () {
      ...
      document.append('user_id', this.$store.state.user.id)
      ...
      documentService.createDocument(document).then(response => {
        this.loading = false
        this.$emit('close')
        EventBus.$emit('documents:created')
      })
    }
  }
}
